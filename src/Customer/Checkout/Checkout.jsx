...
const Checkout = ({navigation}) => {
  ...
  const {data, totalPrice, discount, actualPrice} = useSelector(
    state => state.cart,
  );
    ...
    <SafeAreaView style={{backgroundColor: bgColor, flex: 1}}>
      {loading ? (
        ...
        <>
            ...
            <View
              ...
              <View style={styles.section}>
                ...
                <FlatList
                  ...
                  renderItem={({item, index}) => (
                    <View
                      style={[GlobalStyle.card, GlobalStyle.row, {gap: 20}]}>
                      <Image style={styles.image} source={{uri: item?.image}} />
                      <View style={{flex: 1}}>
                        <Text
                          style={[
                            GlobalStyle.orderMainText,
                            {fontSize: generalFontSize - 2},
                          ]}>
                          {item?.name}
                        </Text>
                        <Text
                          style={[GlobalStyle.orderMinText, {marginBottom: 0}]}>
                        ...
                        <Text
                          ...
                          ${!item.shippingPrice ? 0 : item?.shippingPrice}
                        </Text>
                        <Text
                          style={[GlobalStyle.orderMinText, {marginBottom: 0}]}>
              ...
              <View style={styles.section}>
                <View
                  ...
                  <Text style={[styles.heading, margin('', 0)]}>
                    Shipping Address
                  </Text>
                  <TouchableOpacity
                    onPress={toggleModal}
                    style={[padding('horizontal', 20), padding('vertical', 5)]}>
                ...
                <View style={[GlobalStyle.card, {gap: 10}]}>
                  <View
                    ...
                    <Text style={[GlobalStyle.orderMinText, {marginBottom: 0}]}>
                      Name:{' '}
                    </Text>
                    <Text
                      style={[
                  ...
                  <View
                    ...
                    <Text
                      ...
                      {authData?.address
                        ? `${authData?.address}, ${authData?.city}, ${authData?.state?.name}, ${authData?.country?.name}`
                        : 'No Address Found'}
                    </Text>
                  </View>
                  <View
              ...
              <View style={styles.section}>
                ...
                <View style={[GlobalStyle.card, {gap: 10}]}>
                  ...
                  {errors.code && (
                    <Text
                      style={{color: 'red', marginTop: 5, textAlign: 'right'}}>
                      {errors.code.message}
                    </Text>
                  )}
                </View>
          ...
          <AddPhoneModal
            modalIsVisible={showPhoneModal}
            closeModal={togglePhoneModal}
          />
          <View
            style={{
              position: 'absolute',
            ...
            <TouchableOpacity
              onPress={() => orderNow()}
              style={[GlobalStyle.themeBtn, margin('top', 10)]}>
              <Text style={[GlobalStyle.themeBtnText]}>Order Now</Text>
            </TouchableOpacity>
            <StripePayment
              amount={totalPrice}
