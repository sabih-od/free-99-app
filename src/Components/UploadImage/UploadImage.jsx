...
const UploadImage = ({ imagePicker, photos, imagePickerImage, deleteImage, deleteButton, productId, imageIds, setPhotos }) => {
            ...
            <View style={[GlobalStyle.card, { marginTop: 10 }]}>
                {photos.length > 1 ? (
                    <Carousel
                        ...
                        renderItem={({ item, index }) => (
                            ...
                            <ImageBackground style={styles.mainImg} imageStyle={{ resizeMode: 'cover', borderRadius: 10, borderWidth: 1, borderColor: textColor }} source={{ uri: item?.sourceURL }}>
                    ...
                    <Image style={[styles.mainImg, { borderRadius: 10, resizeMode: 'cover', borderColor: textColor, borderWidth: 1 }]} source={{ uri: defaultImage }} />
                )
                    : (
                        <ImageBackground style={styles.mainImg} imageStyle={{ resizeMode: 'cover', borderRadius: 10, borderWidth: 1, borderColor: textColor }} source={{ uri: imageData[0]?.sourceURL }}>
                            {/* {deleteButton &&
                                <View style={{
                                    marginTop: 10,
                                    marginRight: 10,
                ...
                <View style={[GlobalStyle.row, GlobalStyle.aic, { gap: 10 }]}>
                    ...
                    <TouchableOpacity
                        ...
                        onPress={imagePicker}
                    >
                        <Text style={[GlobalStyle.themeBtnText, { fontSize: generalFontSize }]}>Upload gallery images</Text>
                    </TouchableOpacity>
                </View>
            </View>
        </>
