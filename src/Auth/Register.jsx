...
import { bgColor, gap, generalFontSize, GlobalStyle, isIpad, margin, padding, textColor, windowHeight } from '../Styles/Theme';
                    ...
                    <View style={[GlobalStyle.container, GlobalStyle.jc, { minHeight: windowHeight }]}>
                        ...
                        <View style={{ alignItems: 'center' }}>
                            ...
                            <TouchableOpacity
                                ...
                                <Text style={[GlobalStyle.themeBtnText, { color: textColor, fontSize: generalFontSize - 3, textTransform: 'none' }]}>Already have an account?</Text>
                                <Text style={[GlobalStyle.link, { fontSize: generalFontSize - 3 }]}> Login Now</Text>
                            </TouchableOpacity>
                        </View>
                    </View>
                </ScrollView>
